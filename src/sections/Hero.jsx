...
import { Element } from "react-scroll"; // 👈 bunu ekle
    ...
    <Element name="home">
      ...
      >
        ...
        >
          ...
          <motion.h1 className="text-white uppercase text-[50px] font-bold">
            We will build your dream
          </motion.h1>

          <div className="w-[120px] h-[6px] bg-yellow-500 my-[20px]"></div>
          <p className="text-white text-[20px] mb-[20px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa
            architecto quos non quas est odit sint facere blanditiis debitis
            dolores.
          </p>
