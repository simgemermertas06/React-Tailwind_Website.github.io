  ...
  return (
    <div id="working" className="w-full bg-white">
      ...
      >
        ...
        <motion.h1
          variants={slideUpVariants}
          className="text-black text-[40px] font-bold text-center uppercase"
        >
          how ıt's working
        </motion.h1>
        <motion.div
        ...
        >
          {planning.map((item, index) => (
            ...
            >
              <div>
                <item.icon className="size-[80px] bg-yellow-500 hover:bg-black hover:fill-white p-4 rounded-full transition-colors duration-300 ease-in-out cursor-pointer" />
              </div>
